...
def clima(cidade):
	...
	if retorno["cod"] == 200:
		...
		clima = (f"Em {cidade} a temperatura é de {str(int(current_temperature - 273.15))} graus celcius e humidade de {str(current_humidity)} %")
...
def main():
	cria_audio("ola.mp3", "Olá sou a Stacy, sua assistente virtual! Como posso ajudar?")
	while True:
		monitora_audio()
